...
** profiles
   ...
   Since [[https://pqrs.org/osx/karabiner/document.html#command-line-interface][karabiner cli]] now support set variables, profiles are mainly used for
   multiple users using same the machine or gaming profile and normal profile.
   Goku don't support that well for now.
   ...
   If you just want to have a empty profile for gaming. You can just create one
   in karabiner gui (no need to change anything in goku).
...
** same key in different mode, from @nikitavoloboev's [[https://github.com/nikitavoloboev/dotfiles/blob/178ed88fadaeb889e8a5431e9790f0791dd75b05/karabiner/karabiner.edn#L718][config]]
   Use [[https://pqrs.org/osx/karabiner/document.html#command-line-interface][karabiner command line interface]] to set variable when you open specifc
   type of files in your editor.
