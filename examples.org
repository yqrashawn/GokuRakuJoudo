...
** profiles
   ...
   Since [[https://pqrs.org/osx/karabiner/document.html#command-line-interface][karabiner cli]] now supports set variables, profiles are mainly used for
...
** same key in different mode, from @nikitavoloboev's [[https://github.com/nikitavoloboev/dotfiles/blob/178ed88fadaeb889e8a5431e9790f0791dd75b05/karabiner/karabiner.edn#L718][config]]
   Use [[https://pqrs.org/osx/karabiner/document.html#command-line-interface][karabiner command-line interface]] to set variables when you open specifc
